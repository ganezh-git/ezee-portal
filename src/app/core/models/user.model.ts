...
export const PORTAL_SYSTEMS: SystemAccess[] = [
  { slug: 'permit', name: 'Permit System', icon: 'assignment', description: 'Safety Permit-to-Work management and compliance', route: '/permit', color: '#3b82f6' },
  { slug: 'permit-birla', name: 'Birla Opus Permits', icon: 'verified_user', description: 'Birla Opus Permit-to-Work system', route: '/permit-birla', color: '#e65100' },
